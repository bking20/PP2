...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("PrefixMatcher", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("PrefixMatcher", null, 0, 0);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "24";
		app.meta["company"] = "Brian King";
		app.meta["file"] = "PrefixMatcher";
		app.meta["name"] = "PrefixMatcher";
		app.meta["packageName"] = "PrefixMatcher";
		...
		app.window.context.attributes.background = 30489;
